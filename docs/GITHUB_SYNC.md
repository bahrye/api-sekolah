...
Sinkronisasi data sekolah berjalan otomatis dari portal data resmi pemerintah ke database **Supabase (PostgreSQL)** melalui aplikasi Cloudflare Pages.
...
1. **GitHub Actions Scheduler** (`.github/workflows/sync-sekolah-15m.yml`):
...
2. **Smart Sync & Batching** (`scripts/fetch-custom.cjs`):
   - Mengambil data dari API resmi Pusat secara bertahap.
