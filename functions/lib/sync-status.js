    ...
    sinkronisasi: {
      ...
      catatan:
        runState === 'stalled'
          ...
          : runState === 'running'
            ? cron.enabled
              ? 'Cron /tick tiap menit: ~400–500 sekolah/chunk; jika data sudah sinkron (fp_skip tinggi, sedikit ubah) otomatis burst hingga ~10 chunk (~5.000 sekolah/menit) agar scan mingguan jauh lebih cepat.'
